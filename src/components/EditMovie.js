...
//edit kısmında yazıları editleyebilmek için;
onInputChange = (e) => {
    ...
    handleFormSubmit = (e) => {
        //preventDefault'ı sayfamızın yenilenmesini engellemek için kullandık ve npm form serialize indirdik
        e.preventDefault();
//1.yol
...
//2.yol
        ...
        //history'deki / işaret anasayfaya dönmemizi sağlıyor
    }
